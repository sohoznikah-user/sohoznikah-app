...
export function Navbar() {
  ...
  return (
    <div className=" flex items-center z-20 justify-center p-4 text-[#1f4f69] bg-transparent  border-b border-gray-200">
      ...
      <div className="min-w-96 flex justify-end space-x-4 text-md">
        {user?.role === "USER" && (
          <>
            {biodata?.status === "" ? (
              <Link
